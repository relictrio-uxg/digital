<?php
  /*
  * Template part for Home Hero_banner component
  *
...
<div class="container container--fluid  ">
    ...
    <section>
        ...
        ?>
        <h1 class="heading--variation6 hero__text--head"><?php echo $hero_banner_heading ;?></h1>
        <?php
            }
        ?>
        <?php 
        ...
        ?>
        <p class="heading--variation7 hero__text--subhead pad-tp--40"><?php echo $hero_banner_description ;?></p>
        <?php
        }
        ?>
        </div>
