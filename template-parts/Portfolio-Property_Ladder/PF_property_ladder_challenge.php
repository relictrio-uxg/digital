    ...
    <div class="property__menutabsticky">
      <ul class="property__menutab">
        ...
        <li class="heading heading--variation3 property__menutab--list">
          <a class="<?php echo $row['menu_active_class'] ;?>" 
          href="<?php echo $row['menu_link'] ;?>">
        ...
        <?php 
          ...
          <div class="relictrio--row">
            ...
            ?>
              ...
              <img class="para property__challenge--icon"
                src="<?php echo $row['right_icon_1'] ;?>"
                alt="portfolio-property-ladder-challenge-logo-1">
              <img class="para property__challenge--icon"
                src="<?php echo $row['right_icon_2'] ;?>"
            ...
            <div class="relictrio--row">
              ...
              ?>
                <img class="property__challenge--img"
                  src="<?php echo $challenge_image_1; ?>"
              ...
              ?>
                <img class="property__challenge--img"
                  src="<?php echo $challenge_image_2; ?>"
                  alt="portfolio-property-ladder-challenge-img">
              <?php 
                }
              ?>
